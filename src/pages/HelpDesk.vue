<template>
  <div class="w-full max-w-full px-3 text-center [flex:0_0_auto]">
    ...
    <h5 class="font-normal dark:text-white text-[#8392ab]">
        ...
        <div class="w-full max-w-full px-3 mx-auto my-12 [flex:0_0_auto]">
          <div class="grid grid-cols-3">
            ...
            <button
              ...
              type="button"
              class="before:w-[0.85rem] before:h-[0.85rem] before:rounded-[50%] after:top-[5px] rounded-0 indent-[-82.5rem] relative m-0 cursor-pointer border-none bg-transparent px-1.5 pb-0.5 pt-5 text-[#dee2e6] outline-none transition-all ease-linear before:absolute before:top-0 before:left-1/2 before:z-30 before:box-border before:block before:-translate-x-1/2 before:border-2 before:border-solid before:border-current before:bg-white before:transition-all before:ease-linear before:content-[''] after:absolute after:left-[calc(-50%-13px/2)] after:z-10 after:block after:h-0.5 after:w-full after:bg-current after:transition-all after:ease-linear after:content-[''] sm:indent-0"
              title="Address"
            >
              Address
            </button>
      ...
      <div class="flex flex-wrap -mx-3">
        <div class="w-full max-w-full px-3 m-auto [flex:0_0_auto]">
          <form class="relative mb-32" style="height: 423px">
            ...
            >
              <div class="flex flex-wrap -mx-3 text-center">
                <div class="w-10/12 max-w-full px-3 mx-auto [flex:0_0_auto]">
                  <h5 class="text-[#344767] font-normal dark:text-white">
              ...
              <div>
                <div class="flex flex-wrap mt-4 -mx-3">
                  <div class="w-full max-w-full px-3 [flex:0_0_auto] sm:w-4/12">
                    <div
                      class="relative inline-flex items-center justify-center text-white transition-all duration-200 w-28 h-28 text-base ease-in-out rounded-xl"
                    >
                      <img
                      ...
                      /><a
                        href="javascript:;"
                        class="inline-block w-6 h-6 p-[0.125rem] right-0 bottom-0 absolute -mb-2 -mr-2 font-bold text-center uppercase align-middle transition-all bg-gradient-to-tl from-[#ced4da] to-[#ebeff4] text-[#3a416f] border-0 border-transparent border-solid rounded-lg cursor-pointer leading-pro text-[.75rem] ease-in tracking-tight shadow-md bg-150 bg-x-25 active:opacity-[.85]"
                        ><i
                          class="top-0 fa fa-pen text-[.5rem]"
                          aria-hidden="true"
                        ></i
                      ></a>
                    </div>
                  ...
                  <div
                    class="w-full max-w-full px-3 mt-6 text-left [flex:0_0_auto] sm:w-8/12 sm:mt-0"
                  >
                    <label
            ...
            <div
              form="account"
              class="absolute top-0 left-0 flex flex-col w-full min-w-0 p-4 break-words bg-white border-0 dark:bg-grey-950 dark:shadow-dark-xl shadow-xl rounded-2xl bg-clip-border h-0 opacity-0 invisible"
            >
              <div class="flex flex-wrap -mx-3 text-center">
                <div class="w-10/12 max-w-full px-3 mx-auto [flex:0_0_auto]">
                  <h5 class="text-[#344767] font-normal dark:text-white">
              ...
              <div>
                <div class="flex flex-wrap mt-6 -mx-3">
                  <div
                    class="w-full max-w-full px-3 ml-auto sm:[flex:0_0_auto] sm:w-3/12 shrink-0"
                  >
                    <input
                      id="design"
                      type="checkbox"
                      class="absolute pointer-events-none peer [clip:rect(0,0,0,0)]"
                    /><label
                      checkbox-color-label=""
                      for="design"
                      class="inline-block px-16 py-12 mb-4 ml-1 font-bold text-center uppercase align-middle transition-all bg-transparent border-2 border-solid rounded-lg shadow-none cursor-pointer group peer-checked:bg-[#8392ab] hover:scale-[1.02] leading-pro text-[.75rem] ease-in tracking-tight active:opacity-[.85] active:shadow-xs border-[#8392ab] text-[#8392ab] hover:border-[#8392ab] hover:bg-transparent hover:opacity-75 active:border-[#8392ab] active:bg-[#8392ab] active:text-white"
                      ><svg
                  ...
                  <div
                    class="w-full max-w-full px-3 sm:[flex:0_0_auto] sm:w-3/12 shrink-0"
                  >
                    <input
                      id="code"
                      type="checkbox"
                  ...
                  <div
                    class="w-full max-w-full px-3 mr-auto sm:[flex:0_0_auto] sm:w-3/12 shrink-0"
                  >
                    <input
                      id="develop"
                      type="checkbox"
                    ...
                    /><label
                      checkbox-color-label=""
                      for="develop"
                      class="select-none inline-block px-16 py-12 mb-4 ml-1 font-bold text-center uppercase align-middle transition-all bg-transparent border-2 border-solid rounded-lg shadow-none cursor-pointer group peer-checked:bg-[#8392ab] hover:scale-[1.02] leading-pro text-[.75rem] ease-in tracking-tight active:opacity-[.85] active:shadow-xs border-[#8392ab] text-[#8392ab] hover:border-[#8392ab] hover:bg-transparent hover:opacity-75 active:border-[#8392ab] active:bg-[#8392ab] active:text-white"
                      ><svg
                        class="text-slate-700"
                        width="20px"
                        height="20px"
            ...
            <div
              form="address"
              class="absolute top-0 left-0 flex flex-col invisible w-full h-0 min-w-0 p-4 break-words bg-white border-0 opacity-0 dark:bg-grey-950 dark:shadow-dark-xl shadow-xl rounded-2xl bg-clip-border"
            >
              <div class="flex flex-wrap -mx-3 text-center">
                <div class="w-10/12 max-w-full px-3 mx-auto [flex:0_0_auto]">
                  <h5 class="text-[#344767] font-normal dark:text-white">
              ...
              <div>
                <div class="flex flex-wrap -mx-3 text-left">
                  ...
                  <div
                    class="w-full max-w-full px-3 mt-4 ml-auto [flex:0_0_auto] md:w-5/12"
                  >
                    <label
                      class="mb-2 ml-1 font-bold text-[.75rem] text-slate-700 dark:text-white/80"
                      for="Country"
                    ...
                    >
                      <div class="choices__inner">
                        <select
                          choice=""
                          class="focus:shadow-[0_0_0_2px_#e9aede] dark:bg-grey-950 dark:placeholder:text-white/80 dark:text-white/80 text-[.875rem] leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-grey-300 bg-white bg-clip-padding px-3 py-2 font-normal text-grey-700 outline-none transition-all placeholder:text-grey-500 focus:border-[#e293d3] focus:outline-none choices__input"
                      ...
                      >
                        ...
                        <div class="choices__list" role="listbox">
                          <div
                            id="choices--choices-country-tq-item-choice-1"
                          ...
                          <div
                            id="choices--choices-country-tq-item-choice-2"
                          ...
                          <div
                            id="choices--choices-country-tq-item-choice-3"
                            class="choices__item choices__item--choice choices__item--selectable"
                            role="option"
                            data-choice=""
                            data-id="3"
                          ...
                          <div
                            id="choices--choices-country-tq-item-choice-4"
                            class="choices__item choices__item--choice choices__item--selectable"
                            role="option"
                            data-choice=""
                            data-id="4"
                          ...
                          <div
                            id="choices--choices-country-tq-item-choice-5"
                          ...
                          <div
                            id="choices--choices-country-tq-item-choice-6"
                            class="choices__item choices__item--choice choices__item--selectable"
                            role="option"
                            data-choice=""
                            data-id="6"
